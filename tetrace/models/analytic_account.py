...
class AccountAnalyticLineRel(models.Model):
    ...
    general_account_id = fields.Many2one(related="analytic_line_id.general_account_id", store=True)
    account_id = fields.Many2one(related="analytic_line_id.general_account_id.tetrace_account_id", store=True)
